...
function Features() {
  return (
    <section id="features" className="max-md:mt-8 md:mt-12 pb-8 max-md:pt-8 md:pt-28 flex justify-start flex-col items-center w-full bg-[#FAF9F5]">
      ...
      <FeaturesCard title="112 CDN نقطه ای" list={["صفحات وب و شیوه نامه ها را فشرده کنید", "کاهش زمان انتقال فایل", "پیکربندی خودکار برای میزبانی WPMU DEV", "CSS, JavaScript, HTML"]} />
    </section>
  );
}
