...
function Features() {
  return (
    <section className="max-md:mt-8 md:mt-12 max-md:pt-8 md:pt-28 flex justify-start flex-col items-center w-full bg-[#FAF9F5]">
      ...
      <div className="w-full max-sm:px-8 max-md:px-12 md:px-[35%] max-md:mt-8 md:mt-28 py-14 flex items-center justify-start max-md:flex-col max-md:items-start max-md:gap-4 md:gap-44">
