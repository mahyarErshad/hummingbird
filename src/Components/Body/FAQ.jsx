...
function FAQ() {
  return (
    <section className="py-24 md:px-20 max-md:px-4 w-[95%] max-w-[60rem] mx-auto bg-[#fafafa] rounded-[20px] flex-center flex-col mb-12 shadow-lg">
      ...
      <FAQCard title="آیا Hummingbird Pro از Multisite پشتیبانی می کند و به چه برنامه ای نیاز دارم؟" description="آیا Hummingbird Pro از Multisite پشتیبانی می کند و به چه برنامه ای نیاز دارم؟" />
      <FAQCard
