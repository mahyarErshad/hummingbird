...
function FAQCard({ title, description }) {
  ...
  return (
    <figure>
      <div onClick={() => setOpen((prev) => !prev)} className="border-t border-b border-[#e6e6e6] w-full py-3 px-8 cursor-pointer flex-center transition-all duration-300 hover:border-primary hover:text-primary flex-col">
        <div className="flex-center text-inherit">
