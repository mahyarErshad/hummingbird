...
function FeaturesCard(props) {
  return (
    <div className="featureCards w-full max-w-[60rem] mx-auto px-6 py-8 border-b border-[#e6e6e6] flex items-start justify-start max-md:flex-col max-md:items-start max-md:gap-4 md:gap-8">
